package com.csair.ehomesaas.base.utils.status.imp

import android.os.Bundle
import com.csair.ehomesaas.base.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.csair.ehomesaas.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
